...
현업에서 가장 많이 사용하는 2가지의 DBMS 를 서로 비교함으로써
데이터베이스에 대한 이론을 정리해보기 바람

Oracle 에서는 사용자가 Scheme 가 되며 
MySQL 사용자는 DMBS, 물리적저장소 등에 접근하는 권한을 가진 사용자 개념이다
...
UNION ALL
SELECT '취미 Enitiy', COUNT(*) FROM tbl_hobby
UNION ALL
